...
evaluate_pgn <- function(pgn_path, engine, n_pv, go_mode, go_value,
  ...
  # Evaluate the games
  evaluation_loop <- function(row_number, pgn, engine, n_pv, go_mode, go_value,
                              start_time, progress_path, pgn_basename,
                              file_count) {
    ...
    evaluation <- evaluate_game(movetext, engine, n_pv, go_mode, go_value)
    # Show progress
    if (!mute) {
  ...
  lapply(row_numbers, evaluation_loop, pgn, engine, n_pv, go_mode, go_value,
         start_time, progress_path, pgn_basename, file_count)
}
